...
from .models import (
    Attraction, City, Country, ExtraService, FAQ, ItineraryDay,
...
@register(TeamMember)
class TeamMemberTranslationOptions(TranslationOptions): fields = ("full_name", "position", "description")
...
class ItineraryDayTranslationOptions(TranslationOptions): fields = ("title", "description", "altitude", "walking_distance", "driving_distance", "accommodation")

@register(ExtraService)
class ExtraServiceTranslationOptions(TranslationOptions): fields = ("title", "description", "price_label")

@register(FAQ)
class FAQTranslationOptions(TranslationOptions): fields = ("question", "answer")

@register(TourRoutePoint)
class TourRoutePointTranslationOptions(TranslationOptions): fields = ("title",)
