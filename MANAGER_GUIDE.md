...
Примеры: горные туры, конные туры, культурные туры, трекинг.
...
3. Скопируйте **App ID**
4. В админке: **Настройки сайта -> Виджеты отзывов -> Elfsight Google Reviews App ID**
...
3. В админке: **Настройки сайта -> Виджеты отзывов**
...
Большинство текстовых полей имеют вкладки: **Русский**, **Английский**, **Испанский**, **Французский**, **Немецкий**.
...
> Если перевод не заполнен, на соответствующей языковой версии может появиться резервный текст или пустой текст.
